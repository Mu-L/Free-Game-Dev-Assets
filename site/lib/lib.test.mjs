...
throws("bad walked date", badStack((m) => m.replace("2026-09-20", "20 Sept")), "walked is not a real YYYY-MM-DD date");
...
import { isRealDate, latestAllowedDate } from "./shared.mjs";
